  ...
  return (
    <div className="flex w-full min-h-screen">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-zinc-950 overflow-y-auto">
        <div className="w-full max-w-md bg-white/[0.02] border border-white/5 rounded-2xl p-10 sm:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.5)] backdrop-blur-2xl m-auto my-8">
          <h2 className="mb-2 text-3xl font-bold">Create an account</h2>
          <p className="mb-8 text-base text-gray-400">
            Get started with SyncTunes today
          </p>
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            />
            {fieldErrors.username && <span className="text-red-500 text-xs mt-1">{fieldErrors.username}</span>}
          </div>
          <div className="flex flex-col gap-2">
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link to="/login" className="font-semibold text-primary hover:text-primary-hover transition-colors">Sign in</Link>
        </p>
        </div>
      </div>
    </div>
